...
def run_slang_analyser(subnames, word_to_subs_global_path="word_frequencies_to_subreddit.pkl", total_freq_path="total_freq.pkl", subs_to_num_path="subs_to_num.pkl", save_name='temporary2', save_file=False, pmi=True):
