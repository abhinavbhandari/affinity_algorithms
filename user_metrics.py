...
class SubredditMetrics(object):
    ...
    def __init__(self, sbcs, n=10000):
        ...
        # return values is a list that contains total_dedicated, intersect_total_users, intersect_total_comments, intersect_loyalty 
        # Also INTERSECT means exists across different time periods. In other words, an intersecting user is a user that participates on reddit on all the given time periods.
    ...
    def get_subreddit_rankings_by_metrics(self, intersect_total_comments, intersect_loyalty, total_dedicated, intersect_total_users):
        loyalty_vals = []
        dedicated_vals = []
        comment_vals = []
        user_vals = []
...
#         jj = extract_loyal_users.get_subreddit_to_loyalty()
...
def retrieve_user_metrics(sbcs, n=10000):
    ...
    # intersect_total_comments = calculate_total_number_of_comments_in_subs(int_subs_author_total)
    # # Fix the following function and clean it. 
